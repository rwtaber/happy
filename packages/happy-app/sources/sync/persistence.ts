...
export type NewSessionAgentType = 'claude' | 'codex' | 'gemini' | 'openclaw' | 'copilot' | 'agy';
...
export function loadNewSessionDraft(): NewSessionDraft | null {
    ...
    try {
        ...
        const agentType: NewSessionAgentType = parsed.agentType === 'codex' || parsed.agentType === 'gemini' || parsed.agentType === 'openclaw' || parsed.agentType === 'copilot' || parsed.agentType === 'agy'
            ? parsed.agentType
            : 'claude';
